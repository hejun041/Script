...
!(async () => {
    if (typeof $request !== "undefined") {
        ...
        for (let k = 0; k < zq_cookieArr.length; k++) {
            ...
            zq_cookie1 = cookie_id + '&device_brand=xfdg&device_id=cc7dgdsgfsz83e&device_model=1gx&device_platform=android&device_type=android&inner_version=202108181034&mi=0&openudid=cc7dgdsgfsz83e&os_api=26&os_version=bdftgsdfga&phone_network=WIFI&phone_sim=1' + '&request_time=' + time1 + '&time=' + time1 + '&' + bodyVal
